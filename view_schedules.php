...
<body>
    ...
    <table>
        ...
        $sql = "SELECT schedule.class_id, classes.class_name, schedule.num_students, schedule.start_date, schedule.end_date 
                FROM schedule 
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='4'>No scheduled classes found</td></tr>";
        }
        $conn->close();
        ?>
    </table>
